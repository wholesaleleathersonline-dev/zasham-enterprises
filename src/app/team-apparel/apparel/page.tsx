...
const categoryName = "Team Apparel";
...
setCurrentPage(1);
  ...
  {categoryName}
         ...
         {`Premium custom ${categoryName.toLowerCase()} manufactured with premium materials, professional craftsmanship and worldwide shipping.`}
          </p>
