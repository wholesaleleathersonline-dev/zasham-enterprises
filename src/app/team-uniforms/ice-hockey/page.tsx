...
import { icehockey } from "../../../data/ice-hockey";
...
export default function IceHockeyProductsPage() {
...
<section className="border-b border-[#D4AF37]/20 pt-32 pb-10">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="mt-6 max-w-3xl text-lg text-gray-400">
            Premium custom Ice Hockey uniforms manufactured with professional
            sublimation printing, lightweight performance fabrics and worldwide
            shipping.
          </p>
