      ...
      <section className="border-b border-[#D4AF37]/20 pt-44 pb-16 lg:pt-48">
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-gray-400">
            Premium custom sports caps manufactured by Zasham Enterprises
            using high-quality materials, precision embroidery, professional
            stitching and unlimited customization for schools, clubs,
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="rounded-3xl border border-[#D4AF37]/20 bg-[#161616] p-16 text-center transition-all duration-300 hover:border-[#D4AF37] hover:shadow-[0_0_35px_rgba(212,175,55,0.20)]">
            ...
            <p className="mx-auto mt-6 max-w-2xl leading-8 text-gray-400">
              We are preparing our premium collection of custom sports caps.
