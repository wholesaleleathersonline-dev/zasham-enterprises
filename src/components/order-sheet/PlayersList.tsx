  ...
  <table className="w-full">
    <thead>
      <tr className="border-b border-yellow-500/30 text-left text-yellow-400">
        ...
        <th className="p-3">Top Style</th>
        <th className="p-3">Jogger</th>
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 text-sm">
        ...
        <div>
          ...
          <p className="text-white">{player.top_size}</p>
        </div>

        <div>
          <p className="text-gray-400">Bottom Size</p>
          <p className="text-white">{player.bottom_size}</p>
        </div>

        <div>
          <p className="text-gray-400">Shorts</p>
          <p className="text-white">{player.shorts_style}</p>
        </div>

        <div>
          <p className="text-gray-400">Hood</p>
          <p className="text-white">{player.hood}</p>
        </div>
        ...
        <div>
          <p className="text-gray-400">Top Style</p>
          <p className="text-white">
            {player.top_style || "-"}
          </p>
        </div>
        ...
        <div>
          <p className="text-gray-400">Jogger</p>
          <p className="text-white">
            {player.jogger_size || "-"}
          </p>
        </div>
